...
The `fruitCognition` maintainers take all security issues in the project
seriously. Thank you for improving the security of `fruitCognition`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`fruitCognition` leverages GitHub's private vulnerability reporting.
