...
from agent_recruiter.interviewers.policy_evaluation import evaluate_policy

# Import ADK components for runtime use
...
class BaseEvaluatorAgent(ABC):
    ...
    def _before_model_callback(
        ...
        logger.info(
            f"🧠 LLM Request to {os.getenv('LLM_MODEL', 'openai/gpt-4o')}",
            extra={
                "llm_model": os.getenv("LLM_MODEL", "openai/gpt-4o"),
