...
from agent_recruiter.interviewers.models import PolicyEvaluationResult
...
def _try_fix_with_llm(
    ...
    # Get model from environment variable (configure_llm() should have been called)
...
def _parse_llm_output(
    ...
    4. Try using LLM to fix the JSON (last resort)
    """
