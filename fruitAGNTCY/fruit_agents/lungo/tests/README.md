...
- Cross‑transport parity for auction flows (see TRANSPORT_MATRIX in [`test_auction.py`](fruitAGNTCY/fruit_agents/lungo/tests/integration/test_auction.py:1)).

## Directory Layout

- Session / infra orchestration fixtures & agent/client fixtures: [`conftest.py`](fruitAGNTCY/fruit_agents/lungo/tests/integration/conftest.py:1)
- Docker Compose lifecycle helpers (bring up transport and observability components): [`docker_helpers.py`](fruitAGNTCY/fruit_agents/lungo/tests/integration/docker_helpers.py:1)
- Lightweight subprocess runner used for agent processes: [`process_helper.py`](fruitAGNTCY/fruit_agents/lungo/tests/integration/process_helper.py:1)
- Auction supervisor integration tests (parametrized SLIM + NATS): [`test_auction.py`](fruitAGNTCY/fruit_agents/lungo/tests/integration/test_auction.py:1)
- Logistics (order fulfillment) integration test (currently SLIM only): [`test_logistics.py`](fruitAGNTCY/fruit_agents/lungo/tests/integration/test_logistics.py:1)
...
```bash
cp fruitAGNTCY/fruit_agents/lungo/.env.example .env
